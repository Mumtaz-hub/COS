<%@ Page Title="" Language="C#" MasterPageFile="~/master_User.master" AutoEventWireup="true" CodeFile="Status.aspx.cs" Inherits="ShowOrder" %>
...
<div style="margin-left:10%;">
    ...
    <script type="text/javascript">
        $(function () {
            $.ajax({
                type: "POST",
                url: "Status.aspx/GetItemRequestStatus",
                data: '{}',
        ...
        $("body").on("click", "[id*=gvItemRequest] .ShowDetails", function () {
            ...
            popUpObj = window.open("ShowDetail.aspx?Text=" + TransId, "_blank", "WIDTH=1000,HEIGHT=590,scrollbars=no, menubar=no,resizable=yes,directories=no,location=no");
